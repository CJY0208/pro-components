    ...
    KW9U: function(e, t, n) {
            ...
            (e.prototype.getOrCreateModel = function(e) {
              ...
              return (
                ...
                (this.isLibFile(e) && this._hasFetchedLibFiles
                  ? i['editor'].createModel(this._libFiles[e.path.slice(1)], 'javascript', e)
                  : null)
              )
            }),
          ...
          return (
                        ...
                        !u || e.isDisposed()
                          ...
                          : ((l = u
                              ...
                              .filter(function(e) {
                                return (
                                  -1 ===
                                  (d._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(e.code)
                                )
                              })),
                            (c = l
                              .map(function(e) {
            ...
            (t.prototype._convertDiagnostics = function(e, t) {
              var n = t.start || 0,
                ...
                f = []
              return (
                t.reportsUnnecessary && f.push(i['MarkerTag'].Unnecessary),
                t.reportsDeprecated && f.push(i['MarkerTag'].Deprecated),
                {
                  ...
                  switch (f.label) {
                    case 0:
                      return (
                        ...
                        (o = new i['Range'](n.lineNumber, r.startColumn, n.lineNumber, r.endColumn)),
                        (s = e.uri),
                        (a = e.getOffsetAt(n)),
                        [4, this._worker(s)]
                      )
                    case 1:
                      return (u = f.sent()), [4, u.getCompletionsAtPosition(s.toString(), a)]
                    case 2:
                      return (
                        (l = f.sent()),
                        !l || e.isDisposed()
                          ...
                          : ((c = l.entries.map(function(r) {
                              ...
                              if (r.replacementSpan) {
                                var c = e.getPositionAt(r.replacementSpan.start),
                                  f = e.getPositionAt(r.replacementSpan.start + r.replacementSpan.length)
                                l = new i['Range'](c.lineNumber, c.column, f.lineNumber, f.column)
                              }
                              var d = []
                              return (
                                -1 !==
                                  (null === (u = r.kindModifiers) || void 0 === u ? void 0 : u.indexOf('deprecated')) &&
                                  d.push(i['languages'].CompletionItemTag.Deprecated),
                                {
                                  uri: s,
                                  position: n,
                                  offset: a,
              ...
              return c(this, void 0, void 0, function() {
                ...
                return f(this, function(a) {
                  switch (a.label) {
                    ...
                    case 1:
                      return (i = a.sent()), [4, i.getSignatureHelpItems(n.toString(), r)]
                    case 2:
                      return (
                        (o = a.sent()),
                        !o || e.isDisposed()
                              ...
                              ;(t.documentation = { value: p(e.documentation) }),
                                ...
                                e.parameters.forEach(function(n, r, i) {
                                  var o = p(n.displayParts),
                                    s = { label: o, documentation: { value: p(n.documentation) } }
                                  ;(t.label += o),
                                    t.parameters.push(s),
                                    r < i.length - 1 && (t.label += p(e.separatorDisplayParts))
                                }),
                                (t.label += p(e.suffixDisplayParts)),
                                s.signatures.push(t)
                            }),
                            [2, { value: s, dispose: function() {} }])
                      )
                  }
                })
              })
                ...
                return f(this, function(l) {
                  switch (l.label) {
                    case 0:
                      return (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]
                    case 1:
                      return (i = l.sent()), [4, i.getQuickInfoAtPosition(n.toString(), r)]
                    case 2:
                      return (
                        (o = l.sent()),
                        !o || e.isDisposed()
                ...
                return f(this, function(u) {
                  switch (u.label) {
                    case 0:
                      return (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]
                    case 1:
                      return (o = u.sent()), [4, o.getOccurrencesAtPosition(n.toString(), r)]
                    case 2:
                      return (
                        (s = u.sent()),
                        !s || e.isDisposed()
        ...
        k = (function(e) {
          ...
          return (
            ...
            (t.prototype.provideDefinition = function(e, t, n) {
              return c(this, void 0, void 0, function() {
                var n, r, o, s, a, u, l, c, d, p
                return f(this, function(f) {
                  switch (f.label) {
                    case 0:
                      return (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]
                    case 1:
                      return (o = f.sent()), [4, o.getDefinitionAtPosition(n.toString(), r)]
                    case 2:
                      return (
                        (s = f.sent()),
                        !s || e.isDisposed()
                    ...
                    case 3:
                      ...
                      for (a = [], u = 0, l = s; u < l.length; u++)
                        (c = l[u]),
                          ...
                          p && a.push({ uri: d, range: this._textSpanToRange(p, c.textSpan) })
                      return [2, a]
                  }
                })
              })
                ...
                return f(this, function(f) {
                  switch (f.label) {
                    case 0:
                      return (n = e.uri), (r = e.getOffsetAt(t)), [4, this._worker(n)]
                    case 1:
                      return (o = f.sent()), [4, o.getReferencesAtPosition(n.toString(), r)]
                    case 2:
                      return (
                        (s = f.sent()),
                        !s || e.isDisposed()
              ...
              return c(this, void 0, void 0, function() {
                ...
                return f(this, function(u) {
                  switch (u.label) {
                    ...
                    case 1:
                      return (n = u.sent()), [4, n.getNavigationBarItems(t.toString())]
                    case 2:
                      return (
                        (r = u.sent()),
                        !r || e.isDisposed()
                          ...
                          : ((o = function(t, n, r) {
                              var s = {
                                name: n.text,
                                detail: '',
                                kind: I[n.kind] || i['languages'].SymbolKind.Variable,
              ...
              return c(this, void 0, void 0, function() {
                ...
                return f(this, function(l) {
                  switch (l.label) {
                    ...
                    case 1:
                      return (s = l.sent()), [4, s.getFormattingEditsForRange(r.toString(), i, o, A._convertOptions(n))]
                    case 2:
                      return (
                        (a = l.sent()),
                        !a || e.isDisposed()
                ...
                return f(this, function(l) {
                  switch (l.label) {
                    ...
                    case 1:
                      return (
                        (s = l.sent()),
                        [4, s.getFormattingEditsAfterKeystroke(i.toString(), o, n, A._convertOptions(r))]
                      )
                    case 2:
                      return (
                        (a = l.sent()),
              ...
              return c(this, void 0, void 0, function() {
                ...
                return f(this, function(f) {
                  switch (f.label) {
                    ...
                    case 1:
                      return (u = f.sent()), [4, u.getCodeFixesAtPosition(r.toString(), i, o, a, s)]
                    case 2:
                      return (
                        (l = f.sent()),
                        !l || e.isDisposed()
                          ...
                          : ((c = l
                              ...
                              .map(function(t) {
                                return d._tsCodeFixActionToMonacoCodeAction(e, n, t)
                              })),
        ...
        N = (function(e) {
          ...
          return (
            ...
            (t.prototype.provideRenameEdits = function(e, t, n, r) {
              return c(this, void 0, void 0, function() {
                var r, o, s, a, u, l, c, d, p, g
                return f(this, function(f) {
                  switch (f.label) {
                    case 0:
                      return (r = e.uri), (o = r.toString()), (s = e.getOffsetAt(t)), [4, this._worker(r)]
                    case 1:
                      return (a = f.sent()), [4, a.getRenameInfo(o, s, { allowRenameOfImportPath: !1 })]
                    case 2:
                      if (((u = f.sent()), !1 === u.canRename))
                    ...
                    case 3:
                      if (((l = f.sent()), !l || e.isDisposed())) return [2]
                      for (c = [], d = 0, p = l; d < p.length; d++)
                        (g = p[d]),
                          c.push({
                            resource: i['Uri'].parse(g.fileName),
                            edit: { range: this._textSpanToRange(e, g.textSpan), text: n },
                          })
                      return [2, { edits: c }]
                  }
                })
      ...
      function W(e, t) {
        ...
        return (
          ...
          i['languages'].registerHoverProvider(t, new w(r)),
          i['languages'].registerDocumentHighlightProvider(t, new S(r)),
